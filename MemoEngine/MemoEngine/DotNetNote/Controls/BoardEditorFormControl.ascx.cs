...
namespace MemoEngine.DotNetNote.Controls
{
    public partial class BoardEditorFormControl : System.Web.UI.UserControl
    {
        ...
        private void DisplayDataForModify()
        {
            ...
            //lblName.Text = note.UserName;//lblName.Text)
            ...
            {
                string strJs =
                "<script> alert('아이디가 일치하지 않습니다. \\n아이디를 다시 확인하세요.');location.href='/DotNetNote/BoardView.aspx';</script>";
        ...
        private void DisplayDataForReply()
        {
            ...
            txtContent.Text = 
                $"\n\nOn {note.PostDate}, '{txtName.Text}' wrote:\n----------\n>" 
        ...
        protected void btnWrite_Click(object sender, EventArgs e)
        {
            ...
            if (IsImageTextCorrect())
            {
                ...
                note.UserId = Request.Cookies["UserID"].Value;
                note.UserName = txtName.Text;
